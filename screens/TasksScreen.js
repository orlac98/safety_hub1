  ...
  return(
    <TouchableOpacity style ={[styles.itemContainer,{backgroundColor:color}]}  onPress={onPress}>
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <Ionicons name="ios-options" size={24} color="white" style={styles.icon} />
          </TouchableOpacity>
          <TouchableOpacity onPress={onDelete}>
          <Octicons name="trashcan" size={24} color="white" style={styles.icon} />
          </TouchableOpacity>
        </View>
      </TouchableOpacity>
  );
...
const RenderAddListIcon = ({addItemToLists}) => {
  return (
    ...
    large
    icon="plus"
    onPress={() => addItemToLists({title: 'Title',
    ...
    <View style={styles.container}>
      ...
      renderItem={({item: {title,color},index}) => {
          return(
            ...
            onPress={() => {navigation.navigate('TaskList',{title,color})}}
